...
class InternetAdminNasBloc extends Bloc<InternetAdminNasEvent, InternetAdminNasState> {
  final InternetAdminRepository iAdminRepo;

  InternetAdminNasBloc(this.iAdminRepo)
      : super(InternetAdminNasInitial()) {
    on<InternetAdminNasLoadEvent>(_onDataLoadedEvent);
  }

  Future<void> _onDataLoadedEvent(
      InternetAdminNasLoadEvent event, Emitter<InternetAdminNasState> emit)async {
